...
public class CategoryServiceImpl implements CategoryService {
    ...
    private final CategoryRepository catgoryRepository;

    public CategoryServiceImpl(CategoryRepository catgoryRepository) {
        this.catgoryRepository = catgoryRepository;
    }

    @Override
    public Category findById(Long id) {
        return this.catgoryRepository.findById(id).orElseThrow(InvalidCategoryIdException::new);
    }

    @Override
    public List<Category> listAll() {
        return this.catgoryRepository.findAll();
    }
